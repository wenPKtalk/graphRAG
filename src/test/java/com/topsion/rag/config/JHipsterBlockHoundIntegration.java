...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.topsion.rag.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.topsion.rag.security.DomainUserDetailsService", "createSpringSecurityUser");
